...
"ernia-inguinale":("10","K40","Canale inguinale","l'ernia inguinale",["Ernia inguinale","Ernia inguino-scrotale"],"K40",["Sesso maschile","Sollevamento pesi","Tosse cronica","Familiarità"],["Tumefazione inguinale","Dolore sotto sforzo","Bruciore","Sensazione di peso"],"Tra gli interventi chirurgici più comuni. Approccio mini-invasivo con l'équipe chirurgica Bio-Clinic.","Visita chirurgica per ernia inguinale a Bio-Clinic Sassari."),
